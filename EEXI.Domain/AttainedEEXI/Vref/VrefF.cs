...
namespace RPrybluda.EEXI.Domain
{
    ...
    // 2.2.6 Resolution MEPC.350(78)

    public static class VrefF
    {
        public static double vRefF;
        public static double vRefAvg;
        public static double mcrAvg;
        public static double mv;
        public static double mcrME_75;

        public static double CalcVrefF(string shipType, double deadweight, double mcrME, double grossTonnage)
        {
            ...
            vRefF = (vRefAvg - mv) * Math.Pow (mcrME_75 / (0.75 * mcrAvg ), 0.333333);
